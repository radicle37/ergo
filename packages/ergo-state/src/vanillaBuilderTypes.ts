import type {
  ...
  ErgoVanillaStoreApi,
  InferredErgoVanillaStoreActionsInitializer
...
> =
  ...
  > extends never
    ? never
    : ErgoVanillaStoreActionChoiceBuilder<State, NextSelectors, AutoselectorKeys, Mutators>;
...
> =
  ...
  > extends never
    ? never
    : ErgoVanillaStoreActionChoiceBuilderWithActions<
        State,
        Actions,
        NextSelectors,
        AutoselectorKeys,
...
export interface ErgoVanillaStoreInitialBuilder<State extends object> {
  ...
  ) => ErgoVanillaStoreInitialBuilderWithMiddleware<
    State,
  ...
  ) => ErgoVanillaStoreAutoselectorChoiceBuilder<State>;
}

export interface ErgoVanillaStoreInitialBuilderWithActions<
  State extends object,
  Actions extends object
> {
  readonly withMiddleware: <
  ...
  >(
    middleware: ErgoStoreMiddleware<State, MiddlewareInputMutators, MiddlewareOutputMutators>
  ) => ErgoVanillaStoreInitialBuilderWithActionsAndMiddleware<
    State,
    Actions,
    MiddlewareInputMutators,
    MiddlewareOutputMutators
  ...
  readonly withInitialState: (
    getInitialState: ErgoStoreInitialStateGetter<State>
  ) => ErgoVanillaStoreAutoselectorChoiceBuilderWithActions<State, Actions>;
}
...
interface ErgoVanillaStoreInitialBuilderWithMiddleware<
  State extends object,
...
> {
  ...
  ) => ErgoVanillaStoreAutoselectorChoiceBuilder<State, StoreMutators>;
}

interface ErgoVanillaStoreInitialBuilderWithActionsAndMiddleware<
  State extends object,
  Actions extends object,
  InitializerMutators extends ErgoStoreMutators,
  StoreMutators extends ErgoStoreMutators
> {
  readonly withInitialState: (
    getInitialState: ErgoStoreInitialStateGetter<State, InitializerMutators>
  ) => ErgoVanillaStoreAutoselectorChoiceBuilderWithActions<State, Actions, StoreMutators>;
}

interface ErgoVanillaStoreAutoselectorChoiceBuilder<
  State extends object,
...
> {
  ...
  ) => ErgoVanillaStoreSelectorChoiceBuilder<
    State,
    Record<never, never>,
    AutoselectorKeys,
    Mutators
  >;
  readonly withoutAutoselectors: () => ErgoVanillaStoreSelectorChoiceBuilder<
    State,
    Record<never, never>,
    EmptyErgoVanillaStoreAutoselectors,
    Mutators
  >;
}

interface ErgoVanillaStoreAutoselectorChoiceBuilderWithActions<
  State extends object,
  Actions extends object,
  Mutators extends ErgoStoreMutators = EmptyErgoStoreMutators
> {
  readonly withAutoselectors: <AutoselectorKeys extends ErgoStoreAutoselectorKeys<State>>(
    autoselectors: AutoselectorKeys
  ) => ErgoVanillaStoreSelectorChoiceBuilderWithActions<
    State,
    Actions,
    Record<never, never>,
    AutoselectorKeys,
    Mutators
  >;
  readonly withoutAutoselectors: () => ErgoVanillaStoreSelectorChoiceBuilderWithActions<
    State,
    Actions,
    Record<never, never>,
    EmptyErgoVanillaStoreAutoselectors,
...
interface ErgoVanillaStoreSelectorChoiceBuilder<
  State extends object,
...
> {
  readonly withSelectors: <
    const NextSelectors extends ErgoVanillaStoreSelectorArgument<State, NextSelectors>
  >(
    selectors: NextSelectors
  ) => ErgoVanillaStoreSelectorChoiceResult<State, NextSelectors, AutoselectorKeys, Mutators>;
  readonly withActions: <Actions extends object>(
    createActions: InferredErgoVanillaStoreActionsInitializer<
      State,
      Actions,
      Selectors,
      AutoselectorKeys,
    ...
    Mutators
  >;
  readonly withoutActions: () => ErgoVanillaStoreApi<
    State,
    ErgoStoreSelectorMap<State, Selectors, AutoselectorKeys>,
    EmptyErgoVanillaStoreActions,
    Mutators
  >;
}

interface ErgoVanillaStoreSelectorChoiceBuilderWithActions<
  State extends object,
  Actions extends object,
  Selectors extends ErgoStoreSelectorRecord<State>,
  AutoselectorKeys extends ErgoStoreAutoselectorKeys<State>,
...
> {
  ...
  >(
    selectors: NextSelectors
  ) => ErgoVanillaStoreSelectorChoiceWithActionsResult<
    State,
    Actions,
    NextSelectors,
    AutoselectorKeys,
  ...
  readonly withActions: (
    createActions: ErgoVanillaStoreActionsInitializer<
      State,
      Actions,
      Selectors,
      AutoselectorKeys,
...
interface ErgoVanillaStoreActionChoiceBuilder<
  State extends object,
  Selectors extends ErgoStoreSelectorRecord<State>,
  AutoselectorKeys extends ErgoStoreAutoselectorKeys<State>,
  Mutators extends ErgoStoreMutators = EmptyErgoStoreMutators
...
interface ErgoVanillaStoreActionChoiceBuilderWithActions<
  State extends object,
  Actions extends object,
  Selectors extends ErgoStoreSelectorRecord<State>,
  AutoselectorKeys extends ErgoStoreAutoselectorKeys<State>,
